...
void setup()
{
  ...
  AsyncESP32_SC_ENC_Manager AsyncESP32_SC_ENC_manager(&server, NULL, "AsyncESP32-FSWebServer");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_ENC_Manager AsyncESP32_SC_ENC_manager(&server, &dnsServer, "AsyncESP32-FSWebServer");
#endif
