...
void setup()
{
  ...
  Serial.println(ASYNC_ESP32_SC_ENC_MANAGER_VERSION);
...
#if ( USING_ESP32_S2 || USING_ESP32_C3 )
  AsyncESP32_SC_ENC_Manager AsyncESP32_SC_ENC_manager(&webServer, NULL, "AsyncConfigOnSwitch");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_ENC_Manager AsyncESP32_SC_ENC_manager(&webServer, &dnsServer, "AsyncConfigOnSwitch");
#endif

  AsyncESP32_SC_ENC_manager.setDebugOutput(true);

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  AsyncESP32_SC_ENC_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //AsyncESP32_SC_ENC_manager.setConfigPortalTimeout(600);
