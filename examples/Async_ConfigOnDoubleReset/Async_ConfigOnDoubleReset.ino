...
void setup()
{
  ...
  AsyncESP32_SC_ENC_Manager AsyncESP32_SC_ENC_manager(&webServer, NULL, "AsyncConfigOnDoubleReset");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_ENC_Manager AsyncESP32_SC_ENC_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
#endif
